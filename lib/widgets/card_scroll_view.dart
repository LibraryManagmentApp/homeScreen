...
import 'package:home_page/model/category_data.dart';
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text(title[i],style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.w600),)),
                        )
                        ),
                    ],
                  )
